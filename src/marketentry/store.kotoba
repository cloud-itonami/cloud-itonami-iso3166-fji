(ns marketentry.store
  "SSoT for the Republic of Fiji (FJI) market-entry compliance actor,
...
(defn demo-data
  ...
  `:claims-simplified-procurement?` / `:declared-contract-value` are
  ground truth for the `simplified-procurement-ineligible` flagship
  check (Procurement Regulations 2010, reg 29/reg 30 value threshold);
  `:requires-frcs-tin-record?` / `:frcs-tin-record-verified?` are
  ground truth for the conditional FRCS TIN-record check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Suva Fabrication Pte Ltd" :portal "portal.tenderlink.com/economyfiji"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :claims-simplified-procurement? false :declared-contract-value 200000.0
             :requires-frcs-tin-record? true :frcs-tin-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "FJI" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "portal.tenderlink.com/economyfiji"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :claims-simplified-procurement? false :declared-contract-value 200000.0
             :requires-frcs-tin-record? true :frcs-tin-record-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Nadi Logistics Ltd" :portal "portal.tenderlink.com/economyfiji"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "FJI" :status :intake}
    "eng-4" {:id "eng-4" :operator "Labasa Supplies Cooperative" :portal "portal.tenderlink.com/economyfiji"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :claims-simplified-procurement? true :declared-contract-value 78000.0
             :requires-frcs-tin-record? true :frcs-tin-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "FJI" :status :intake}
    "eng-5" {:id "eng-5" :operator "Lautoka Trading Co" :portal "portal.tenderlink.com/economyfiji"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :claims-simplified-procurement? false :declared-contract-value 200000.0
             :requires-frcs-tin-record? true :frcs-tin-record-verified? false
             :drafted? false :submitted? false
             :jurisdiction "FJI" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               claims-simplified-procurement? declared-contract-value
                               requires-frcs-tin-record? frcs-tin-record-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? claims-simplified-procurement?) (assoc :engagement/claims-simplified-procurement? claims-simplified-procurement?)
    (some? declared-contract-value)       (assoc :engagement/declared-contract-value declared-contract-value)
    (some? requires-frcs-tin-record?)     (assoc :engagement/requires-frcs-tin-record? requires-frcs-tin-record?)
    (some? frcs-tin-record-verified?)     (assoc :engagement/frcs-tin-record-verified? frcs-tin-record-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/claims-simplified-procurement? :engagement/declared-contract-value
   :engagement/requires-frcs-tin-record? :engagement/frcs-tin-record-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :claims-simplified-procurement? (boolean (:engagement/claims-simplified-procurement? m))
     :declared-contract-value (:engagement/declared-contract-value m)
     :requires-frcs-tin-record? (boolean (:engagement/requires-frcs-tin-record? m))
     :frcs-tin-record-verified? (boolean (:engagement/frcs-tin-record-verified? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-fji"})
